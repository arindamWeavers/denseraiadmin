...
const PlanModal = ({ state, setState }) => {
      ...
      <div className="flex items-center justify-center min-height-100vh pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-center bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <label className="font-medium text-gray-800">Plan ID</label>
            <input
              type="email"
              className="w-full outline-none rounded bg-gray-100 p-2 mt-2 mb-3"
              disabled
            />
            <label className="font-medium text-gray-800">Plan Name</label>
            <input
              type="email"
              className="w-full outline-none rounded bg-gray-100 p-2 mt-2 mb-3"
              disabled
            />
            <label className="font-medium text-gray-800">Plan Amount</label>
            <input
              type="text"
              className="w-full outline-none rounded bg-gray-100 p-2 mt-2 mb-3"
            />
